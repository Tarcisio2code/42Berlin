...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/25 12:51:00 by tsilva            #+#    #+#             */
/*   Updated: 2026/01/14 19:19:26 by tsilva           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief Overloaded constructor with name initialization.
 * @param name The name to be assigned to the zombie.
 */
Zombie::Zombie( std::string name ) : _name(name){
    std::cout << "A walker has been created !" << std::endl;
}
